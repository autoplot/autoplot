...
public class MLSparse extends MLNumericArray<Double>
{
     ...
     * For j, in the range <tt>0&lt;=j&lt;=N__1</tt>, <tt>jc[j]</tt> is the index in ir and <tt>pr</tt> (and <tt>pi</tt>
     * if it exists) of the first nonzero entry in the jth column and <tt>jc[j+1]__1</tt> index
