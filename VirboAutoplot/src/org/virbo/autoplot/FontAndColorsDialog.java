...
public class FontAndColorsDialog extends javax.swing.JDialog {
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createSequentialGroup()
                        .add(jLabel4)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(fontLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jButton1))
    ...
    private void foregroundColorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_foregroundColorButtonActionPerformed
        ...
        jComboBox1.setSelectedIndex(fores.length);
        if ( app.seriesRend.getColor().equals( app.getCanvas().getForeground() ) ) app.seriesRend.setColor(c);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        if ( i<fores.length ) {
            ...
            if ( app.seriesRend.getColor().equals( app.getCanvas().getForeground() ) ) app.seriesRend.setColor( fores[i] );
