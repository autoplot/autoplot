# autoplot.py v1.11 # do not edit this file, changes will be lost.
# This is copied into each user's autoplot_data/jython folder to be picked up 
...
def getParam( name, deflt, doc='', enums='' ):
  ...
  #   if ( not isinstance(deflt,type(enums[0])) ):
  #      raise Exception("default type %s does not match enumeration type %s" % ( type( deflt), type(enums[0]) ) )
