...
QUERY[7]="main-class=org.virbo.autoplot.AutoplotUI&nativeLAF=true&uri=http://autoplot.org/data/autoplot.cdf?BGSM"
...
QUERY[10]="version=latest&nativeLAF=true&main-class=org.virbo.autoplot.AutoplotUI&open=http://autoplot.org/data/autoplot.cdf?BGSM"
