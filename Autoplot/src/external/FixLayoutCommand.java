...
public class FixLayoutCommand extends PyObject  {
    ...
    public static final PyString __doc__ =
        new PyString("<html><H2>fixLayout([named parameters])</H2>"
            ...
            + "<table>"
            + " <tr><td> horizontalSpacing=1em </td><td>Horizontal spacing between plots, such as 1em</td></tr>\n"
            + " <tr><td> verticalSpacing=1em      </td><td>Vertical spacing between plots, such as 1em</td></tr>\n"
