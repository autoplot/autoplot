...
#    export APDEBUG=1
#    ./autoplot.jar -J-Xmx8G -h --script=sayHello.jy  # note this should result in: java -Xmx4G -Djava.awt.headless=true -jar autoplot.jar org.virbo.autoplot.AutoplotUI  --script=sayHello.jy
#  
