...
public class SmoothFilterEditorPanel extends AbstractFilterEditorPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(bundle.getString("SmoothFilterEditorPanel.jLabel1.text")); // NOI18N

        sizeTF.setText(bundle.getString("SmoothFilterEditorPanel.sizeTF.text")); // NOI18N
