...
//    }
    ...
    private static void testSchemes( ) {
        QDataSet ds;
        System.err.println( "---" );
        ds= VATestSupport.sampleDataRank1(99);
        System.err.println( ds );
        System.err.println( "x: "+SemanticOps.xtagsDataSet( ds ) );
        System.err.println( "y: "+SemanticOps.ytagsDataSet( ds ) );

        System.err.println( "---" );
        ds= VATestSupport.sampleDataRank2(99,20);
        System.err.println( ds );
        System.err.println( "x: "+SemanticOps.xtagsDataSet( ds ) );
        System.err.println( "y: "+SemanticOps.ytagsDataSet( ds ) );

        System.err.println( "---" );
        ds= VATestSupport.sampleQube1( 3.4, 4.5, 22, 32 );
        System.err.println( ds );
        System.err.println( "x: "+SemanticOps.xtagsDataSet( ds ) );
        System.err.println( "y: "+SemanticOps.ytagsDataSet( ds ) );

        System.err.println( "---" );
        ds= VATestSupport.sampleRank3Join();
        System.err.println( ds );
        System.err.println( "x: "+SemanticOps.xtagsDataSet( ds ) );
        System.err.println( "y: "+SemanticOps.ytagsDataSet( ds ) );
    ...
    public static void main(String[] args)  {
        try {
            doTest( VATestSupport.sampleDataRank1(100), null );
            //dumpRank3Ds( VATestSupport.sampleRank3Join() );
            doTest( VATestSupport.sampleRank3Join(), null );
            testSchemes();
