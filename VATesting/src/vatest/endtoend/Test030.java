...
//        }
    ...
    private static void unbundleBug001() throws Exception {
        System.err.println("=======================");
        QDataSet ds2= Util.getDataSet( VATestSupport.TEST_DATA + "dat/headers/CRRES_mod.txt?column=Lstar" );
        System.err.println("=======================");
        QDataSet ds1= Util.getDataSet( VATestSupport.TEST_DATA + "dat/headers/CRRES_mod.txt?column=L" );
        System.err.println("=======================");
    ...
    public static void main(String[] args) throws Exception  {
        try {
            doTestBundle( 2, VATestSupport.TEST_DATA + "dat/headers/CRRES_mod.txt?rank2" );
            
            doTestBundle( 0, VATestSupport.TEST_DATA + "dat/headers/proton_density.dat?rank2" );

            //TODO: DEPEND_0 is lost here.
            doTest( 1, VATestSupport.TEST_DATA + "dat/headers/proton_density.dat?column=Proton_Density" );
