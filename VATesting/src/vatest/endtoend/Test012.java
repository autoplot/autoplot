...
public class Test012 {
    ...
    public static void main(String[] args) {
        try {
            ...
            doTest( testid,0, "vap:" + TEST_DATA + "/cdf/c4_cp_fgm_spin_20030102_v01.cdf?B_vec_xyz_gse__C4_CP_FGM_SPIN" );

            doTest( testid,1, "vap:" + TEST_DATA + "/cdf/tha_l1_efw_20080402_v01.cdf?tha_efw" );
            doTest( testid,2, "vap:" + TEST_DATA + "/cdf/l1_h0_mpa_20020202_v02.cdf?dens_e" );
            doTest( testid,3, "vap:" + TEST_DATA + "/cdf/l1_h0_mpa_20020202_v02.cdf?Theta_l" );
            //rank4
            doTest( testid,4, "vap:" + TEST_DATA + "/cdf/l1_h0_mpa_20020202_v02.cdf?Ecounts[1]" );

            // cdf_epoch16, subsetting.
            doTest( testid,5, "vap:" + TEST_DATA + "/cdf/c2_waveform_wbd_200704170840_u01.cdf?WBD_Elec[1000000:1100000]" );
            // uint1, subsetting.
            doTest( testid,6, "vap:" + TEST_DATA + "/cdf/c2_waveform_wbd_200704170840_u01.cdf?DATA_QUALITY[::1090]" );

            doTest( testid,7, "vap:" + TEST_DATA + "/cdf/i8_15sec_mag_19731030_v02.cdf?F1_Average_B_15s" );
            doTest( testid,8, "vap:" + TEST_DATA + "/cdf/i8_15sec_mag_19731030_v02.cdf?B_Vector_GSM" );

            doTest( testid,9, "vap:" + TEST_DATA + "/cdf/wi_h0_mfi_19941123_v04.cdf?P1GSM" );
            doTest( testid,10, "vap:" + TEST_DATA + "/cdf/wi_h0_mfi_19941123_v04.cdf?ORTH_I" );

            doTest( testid,11, "vap:" + TEST_DATA + "/cdf/po_h0_hyd_20010117_v01.cdf?ION_DIFFERENTIAL_ENERGY_FLUX" );

            // rank 3
            doTest( testid, 12, "vap:" + TEST_DATA + "/cdf/po_h0_tim_19960409_v03.cdf?Flux_H" );

            // recursion bug https://sourceforge.net/tracker/index.php?func=detail&aid=2981336&group_id=199733&atid=970682
            doTest( testid,13, "vap:" + TEST_DATA + "/cdf/tha_l1_fgm_20100101_v01.cdf?tha_fgh[0:10000]" );

            // twins data uses extra DEPEND_x variables.
            doTest( testid,14, "vap:" + TEST_DATA + "/cdf/twins/twins1_l1_imager_2009011102_v01.cdf?smooth_image&interpMeta=no" );

            // this fast ees has rank 2 DEPEND_1.
            doTest( testid,15, "vap:" + TEST_DATA + "/cdf/fa_k0_ees_19980111_v01.cdf?el_0" );

            // this should slice by default on the enumeration (labels) dimension.
            doTest( testid,16, "vap:" + TEST_DATA + "/cdf/tha_l1_ffp_32_20090101_v01.cdf?tha_ffp_32" );

            // every other value is fill in Virbo data.  These should be skipped.
            doTest( testid, 17, "" + TEST_DATA + "/cdf/virbo/poes_n17_20041228.cdf?P1_90[0:300]" );

            // this has a non-varying second dimension that is automatically removed.
            doTest( testid, 18, "" + TEST_DATA + "/cdf/cn_k0_asi_19991230_v01.cdf?Image" );

            // this is a hugeScatter.
            doTest( testid, 19, "" + TEST_DATA + "/cdf/pw/rbsp/rbsp-a_magnetometer_emfisis-L1_20120904_v1.2.2.cdf?Mag_UVW[0:100000]" );

            // this is a hugeScatter.  4,072,000 points.
            doTest( testid, 20, "" + TEST_DATA + "/cdf/pw/rbsp/rbsp-a_magnetometer_emfisis-L1_20120904_v1.2.2.cdf?Mag_UVW" );

            // odd code in the java-reader deals with the odd response from this file.
            doTest( testid, 21, "" + TEST_DATA + "/cdf/ge_k0_lep_20111016_v01.cdf?V0");

            // CDF file with one index having length=1.
            doTest( testid, 22, "" + TEST_DATA + "/cdf/rbspb_pre_ect-mageisHIGH-sp-L1_20130709_v1.0.0.cdf?Histogram_prot");
            
            // bug 1101: trim/slice wasn't properly supported with rank 2 DEPEND_1.
            doTest( testid, 23, "" + TEST_DATA + "/cdf/lanl/rbspb_ect-hope-sci-L2SA_20121219_v3.0.0.cdf?FPSA[0:100:5]" );
