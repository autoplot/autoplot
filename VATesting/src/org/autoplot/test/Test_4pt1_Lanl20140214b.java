...
public class Test_4pt1_Lanl20140214b implements Scenario {
    ...
    public int runIt(Object param) {
        try {
            ...
            new JTextFieldOperator( app.getDataSetSelector().getEditor() ).setText("http://www.rbsp-ect.lanl.gov/data_pub/rbspa/rept/level3/rbspa_rel02_ect-rept-sci-L3_$Y$m$d_v$(v,sep).cdf?FEDU&timerange=20130915");
