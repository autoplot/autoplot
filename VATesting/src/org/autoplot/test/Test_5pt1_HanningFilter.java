 ...
 */
public class Test_5pt1_HanningFilter implements Scenario {
    ...
    public int runIt(Object o) {
        ...
        try {
            ...
            Logger.getLogger(Test_5pt1_HanningFilter.class.getName()).log(Level.SEVERE, null, ex);
            return(1);
	...
	String[] params = {"org.autoplot.test.Test_5pt1_HanningFilter"};
